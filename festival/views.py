...
import openai
openai.api_key = "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"
...
def index(request, *message):
    ...
    return render(request, 'public/index.html', {"festivals": festivals,
...
def festival(request, festival_id):
    ...
    num_tickets = festival.ticket_set.aggregate(total_tickets=Sum('amount'))['total_tickets']
    num_sold_tickets = festival.ticket_set.aggregate(total_sold_tickets=Sum('amount_sold'))['total_sold_tickets']
